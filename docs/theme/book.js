...
(function languages() {
    ...
    function showLanguages() {
        ...
        //langPopup.querySelector("button#" + document.body.className).focus();
    }
    ...
    function set_lang(lang) {
        ...
        try { localStorage.setItem('mdbook-lang', lang); } catch (e) { }

        //do stuff - hiding based on selection
        hideLanguages();
        langToggleButton.innerText = lang;
        $(".language").hide();
        $("."+lang).show();
    }
    ...
    //$("body").html($("body").html().replace(/{/lang=EN}/g,'<span class="language EN">'));

    // Set language
    var lang;
    try { lang = localStorage.getItem('mdbook-lang'); } catch(e) { }
    ...
    document.addEventListener('keydown', function (e) {
        if (e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) { return; }
        if (!langPopup.contains(e.target)) { return; }
        ...
        switch (e.key) {
            ...
            case 'Home':
                e.preventDefault();
                langPopup.querySelector('li:first-child button').focus();
                break;
            case 'End':
                e.preventDefault();
                langPopup.querySelector('li:last-child button').focus();
                break;
        }
    });
})();
