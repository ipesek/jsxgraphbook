...
<script type='text/javascript'>
	...
	brd16.create('segment', [K16,P16], {});//vedno
	brd16.create('segment', [P16,Q16], {});//vedno
	brd16.create('segment', [Q16,N16], {});//vedno
	brd16.create('segment', [N16,K16], {});//vedno
	...
	brd16.create('segment', [L16,M16], {});//vedno
	...
	brd16.create('segment', [Q16,P16], {});//vedno
	...
	var ploscina16 = brd16.create('slider', [[0.5,-4],[9.5,-4],[0,0,8]], {withlabel:false});
		ploscina16.hideElement();
		ploscina16.highline.hideElement();
		ploscina16.baseline.hideElement();
